...
export default function AddContractPage() {
  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      navigate('/local-purchase/contracts');
    } catch (err) {
  ...
  const tabs = [
    ...
    { id: 'security', label: 'Security Deposit' },
                  ...
                  <div className="mb-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-3 items-end">
                      ...
                      <div className="space-y-1 md:col-span-2">
                        <label className="text-sm font-medium text-slate-700">Select Tender No <span className="text-red-500">*</span></label>
                        <select 
                          disabled={isSaved}
                          required
                          className="w-full h-8 px-2 border-slate-200 rounded text-xs focus:ring-1 focus:ring-emerald-500/50 focus:border-emerald-500 transition-shadow disabled:bg-slate-50 disabled:text-slate-500"
                  ...
                  <div className="p-4">
                        ...
                        <div className="px-4 sm:px-4 flex gap-4 items-end">
                          ...
                          <div className="flex-1 max-w-md relative">
                            ...
                            <AsyncSelect 
                              ...
                              onChange={(selectedOption) => setNewItem({...newItem, lpItemId: selectedOption ? selectedOption.value.toString() : ''})}
                          ...
                          <table className="w-full text-left text-[11px] min-w-full table-fixed">
                            <thead className="bg-[#0b3b17] text-white uppercase font-semibold text-[10px] border-b border-slate-200">
                              <tr>
                                ...
                                <th className="px-1 py-2 border-r border-[#155424] w-[12%]">Manufacturer</th>
                              ...
                              {items.map((item, idx) => {
                                ...
                                return (
                                  <tr key={item.id} className="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td className="px-1 py-2 border-r border-slate-200 text-slate-600 truncate text-[10px]">{item.manufacturer || 'N/A'}</td>
                    ...
                    {activeTab === 'security' && (
                      <div className="text-center py-12 border-2 border-dashed border-slate-200 rounded-xl bg-slate-50/50">
                        ...
                        <h4 className="text-base font-semibold text-slate-800">Security Deposit details</h4>
                        <p className="text-sm text-slate-500 mt-1">Manage security deposit information for this contract.</p>
                      </div>
                    )}
                    {activeTab === 'complete' && (
