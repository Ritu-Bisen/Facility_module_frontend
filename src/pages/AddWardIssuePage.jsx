  ...
  async function loadWards() {
    ...
    try {
      ...
      setWards((res.data || []).map((w) =>
        Array.isArray(w) ? { WARDID: w[0], WARDNAME: w[1] } : { WARDID: w.WARDID, WARDNAME: w.WARDNAME }
      ));
    } catch (e) { console.error(e); }
                ...
                <div className="flex flex-wrap items-end gap-6">
                  ...
                  <div className="flex-[2] min-w-[240px] space-y-2">
                    ...
                    <SearchDrop
                      ...
                      labelKey="WARDNAME"
                      valueKey="WARDID"
                      disabled={loadingWards || headerSaved}
                    />
                    {errors.ward && <p className="text-red-500 text-xs font-medium mt-1">⚠ {errors.ward}</p>}
                  </div>
